...
<title>ReEnter details</title>
</head>
<body>

<h1> You Entered wrong details, please enter correct details for Appointment cancellation</h1><br>


 <form action="appntcan"  modelAttribute="appdata" method="post" >
