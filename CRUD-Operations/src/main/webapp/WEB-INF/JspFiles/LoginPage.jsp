...
<body>
<h1>Enter the Email & Password for login</h1><br><br>

<table>
<spri:form modelAttribute="studentsData" action="logindd">
...
<tr><td><input type="submit" value="Login" style="background-color: #2A27F5"></td></tr>
</spri:form>
</table>
<br><br>

<h2>If not registered, please register here</h2><br>
